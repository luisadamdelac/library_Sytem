(function ($) {
  ...
  // Only run banner code if banner elements exist on the page
  if (document.querySelector('#proBanner') || document.querySelector('#bannerClose') || document.querySelector('.navbar') || document.querySelector('.page-body-wrapper')) {
