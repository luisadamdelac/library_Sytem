    ...
    <li class="nav-item nav-profile">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="icons">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="<?= site_url('transactions/add')?>">Borrow Book
                        <i class="mdi mdi-arrow-up-bold menu-icon"></i>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?= site_url('transactions/return_book')?>">Return Book
                        <i class="mdi mdi-arrow-down-bold menu-icon"></i>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?= site_url('Transactions/all_transactions')?>">Borrow History
